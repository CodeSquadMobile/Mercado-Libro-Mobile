...
public class ReviewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inicializar el botón "Volver" y añadir la lógica para regresar
        Button backButton = view.findViewById(R.id.button_volver); // Referenciar el botón
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Utilizar el FragmentManager para retroceder al fragmento anterior
